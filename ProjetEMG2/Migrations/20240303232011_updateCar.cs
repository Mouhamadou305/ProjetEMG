        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrixAchat = table.Column<decimal>(type: "decimal(10,0)", nullable: false),
                    Reparations = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CoutsReparation = table.Column<decimal>(type: "decimal(10,0)", nullable: false),
                    DateDisponibilite = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PrixVente = table.Column<decimal>(type: "decimal(10,0)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cars", x => x.CodeVIN);
                });
